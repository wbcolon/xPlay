...
xPlayerWidgetQt::xPlayerWidgetQt(xMusicPlayer* musicPlayer, QWidget* parent, Qt::WindowFlags flags):
    ...
    connect(clearButton, &QPushButton::pressed, this, &xPlayerWidgetQt::clearQueue);
    connect(clearButton, &QPushButton::pressed, this, &xPlayerWidgetQt::clear);
    // Connect the music player to the player widget.
    connect(musicPlayer, &xMusicPlayer::currentTrack, this, &xPlayerWidgetQt::currentTrack);
    connect(musicPlayer, &xMusicPlayer::currentTrackPlayed, this, &xPlayerWidgetQt::currentTrackPlayed);
    connect(musicPlayer, &xMusicPlayer::currentTrackLength, this, &xPlayerWidgetQt::currentTrackLength);
    connect(musicPlayer, &xMusicPlayer::currentState, this, &xPlayerWidgetQt::currentState);
    ...
    connect(volumeDial, &QDial::valueChanged, this, &xPlayerWidgetQt::setVolume);
...
void xPlayerWidgetQt::currentTrack(int index, const QString& artist, const QString& album, const QString& track) {
...
void xPlayerWidgetQt::currentTrackLength(qint64 length) {
...
void xPlayerWidgetQt::currentTrackPlayed(qint64 played) {
...
void xPlayerWidgetQt::currentState(xMusicPlayer::State state) {
...
void xPlayerWidgetQt::setVolume(int vol) {
